...
```
https://hub.docker.com/repository/docker/roomantix/custom-nginx/general
...
Скриншот-7 к заданию 4
![Скриншот 7](https://github.com/roomantix/05-virt-03-docker-intro/blob/main/img/7.png)
